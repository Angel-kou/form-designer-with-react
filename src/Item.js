            ...
            this.state.type ?
                ...
                <div className="input-group mb-3" >
                    <input type="text" className="form-control" placeholder="Text"
                           aria-label="Recipient's username" aria-describedby="basic-addon2" id="inputType"/>
                        <span className="input-group-append" id="clear">
                            <span className="input-group-text" id="basic-addon2" onClick={this.deleteItem}>X</span>
                        </span>
                </div>
                </div>):
                    (<div id="list">
